...
func Add(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		categories := categorymodel.GetAll() // Mengambil semua kategori
		data := map[string]any{
			"categories": categories, // Mengirim data kategori ke template
		}

		temp.Execute(w, data) // Menjalankan template dengan data
	}
